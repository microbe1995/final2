    ...
    <div className={finalClasses}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="text-center">
          ...
          <div className="text-xs text-gray-500">공정 단계</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-600">{edges.length}</div>
          <div className="text-xs text-gray-500">공정 연결</div>
        </div>
      </div>
      ...
      {(selectedNodes.length > 0 || selectedEdges.length > 0) && (
        <div className="mb-4 p-3 bg-blue-50 rounded-lg">
          <h4 className="text-sm font-medium text-blue-800 mb-2">선택된 요소</h4>
      ...
      {/* 공정 타입별 분포 */}
      <div className="mb-4">
        <h4 className="text-sm font-medium text-gray-700 mb-2">공정 타입별 분포</h4>
        <div className="space-y-2">
      ...
      {/* 연결 타입별 분포 */}
      <div className="mb-4">
        <h4 className="text-sm font-medium text-gray-700 mb-2">연결 타입별 분포</h4>
        <div className="space-y-2">
