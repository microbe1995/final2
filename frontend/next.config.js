        ...
        headers: [
          {
            ...
            value: `default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://dapi.kakao.com https://t1.daumcdn.net https://greensteel.site https://lca-final.vercel.app; style-src 'self' 'unsafe-inline' https://lca-final.vercel.app; img-src 'self' data: https: https://www.google-analytics.com https://greensteel.site https://lca-final.vercel.app; connect-src 'self' ${process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.greensteel.site'} http://localhost:8080 http://localhost:8083 https://www.google-analytics.com https://analytics.google.com https://dapi.kakao.com https://greensteel.site https://lca-final.vercel.app; font-src 'self' data:; frame-src 'self' https://greensteel.site https://postcode.map.daum.net;`,
          },
          {
            key: 'X-Frame-Options',
            value: 'DENY',
